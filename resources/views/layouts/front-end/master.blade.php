...
<!-- Mirrored from bracketweb.com/wallpi-html/index-one-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Dec 2024 05:22:21 GMT -->

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Home One || Wallpi || HTML Template For Home Wallpaper Solution</title>
    <!-- favicons Icons -->
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        ...
                        <div class="main-slider-one__shope">
                            <img src="{{ asset('/') }}website/assets/images/shapes/hero-icon1-1.png"
                                alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row feature-one__row">
                    <div class="col-lg-6 feature-one__col wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-one__item">
                            <div class="feature-one__item__img">
                                <img src="{{ asset('/') }}website/assets/images/resources/feature1-1.jpg"
                                    alt="wallpi">
                            </div>
                    ...
                    <div class="col-lg-6 feature-one__col wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-one__item">
                            <div class="feature-one__item__img">
                                <img src="{{ asset('/') }}website/assets/images/resources/feature1-2.jpg"
                                    alt="wallpi">
                            </div>
                        ...
                        <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                            <div class="about-one__image__wrap">
                                <img class="about-one__image__wrap__main"
                                    src="{{ asset('/') }}website/assets/images/resources/about1-1.jpg"
                                    alt="wallpi">
            ...
            <div class="container">
                ...
                <div class="row gutter-y-20">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            <div class="service-one__item__image">
                                <img src="{{ asset('/') }}website/assets/images/resources/services1-1.jpg"
                                    alt="services">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            <div class="service-one__item__image">
                                <img src="{{ asset('/') }}website/assets/images/resources/services1-2.jpg"
                                    alt="services">
                                <div class="service-one__item__icon">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            <div class="service-one__item__image">
                                <img src="{{ asset('/') }}website/assets/images/resources/services1-3.jpg"
                                    alt="services">
                                <div class="service-one__item__icon">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            <div class="service-one__item__image">
                                <img src="{{ asset('/') }}website/assets/images/resources/services1-4.jpg"
                                    alt="services">
                                <div class="service-one__item__icon">
                            ...
                            <div class="project-one__item__info">
                                <div class="project-one__item__inner">
                                    ...
                                    <div class="project-one__item__bg normal--bg">
                                        ...
                                        <h4 class="project-one__item__heading"><a
                                                href="portfolio-details.html">Ceiling wallpaper</a></h4>
                                        <a href="portfolio-details.html" class="project-one__item__right-arrow">
                                            <i class="icon-arrow-small-right"></i>
                                        </a>
                                    </div>
                            ...
                            <div class="project-one__item__info">
                                <div class="project-one__item__inner">
                                    <div class="project-one__item__bg normal--bg">
                                        ...
                                        <h4 class="project-one__item__heading"><a
                                                href="portfolio-details.html">Interior Painting</a></h4>
                                        <a href="portfolio-details.html" class="project-one__item__right-arrow">
                                            <i class="icon-arrow-small-right"></i>
                                        </a>
                                    </div>
                ...
                <ul class="list-unstyled funfact-one__list">
                    <li class="funfact-one__item count-box">
                        <div class="funfact-one__content text-center">
                            ...
                            <div class="funfact-one__count-wrap">
                                <strong class="funfact-one__count count-text" data-stop="15"
                    ...
                    <li class="funfact-one__item count-box">
                        <div class="funfact-one__content text-center">
                            ...
                            <div class="funfact-one__count-wrap">
                                <strong class="funfact-one__count count-text" data-stop="14"
                                    data-speed="1500"></strong>
                                <span class="funfact-one__counter-num">K+</span>
                            </div>
                    ...
                    <li class="funfact-one__item count-box">
                        <div class="funfact-one__content text-center">
                            ...
                            <div class="funfact-one__count-wrap">
                                <strong class="funfact-one__count count-text" data-stop="11"
                                    data-speed="1500"></strong>
                                <span class="funfact-one__counter-num">K+</span>
                            </div>
                        ...
                        <div class="consultation-one__contentwrap__call">
                            <div class="consultation-one__contentwrap__inner">
                                ...
                                <p class="consultation-one__contentwrap__telnumber">Call Anytime <a
                                        href="tel:+88(000)-4612">+ 88 (000) - 4612</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from bracketweb.com/wallpi-html/index-one-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Dec 2024 05:22:53 GMT -->
